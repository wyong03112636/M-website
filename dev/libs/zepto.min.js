...
!(function(t, e) {
  ...
  var e = (function() {
    ...
    function R(t) {
      return $(t) && !L(t) && Object.getPrototypeOf(t) == Object.prototype;
    }
    function _(t) {
    ...
    function J(t, n) {
      ...
      return n === e
        ? r
          ? i.baseVal
          : i
        : void (r ? (i.baseVal = n) : (t.className = n));
    }
    function K(t) {
      try {
        return t
    ...
    return (
      ...
      (C.fragment = function(t, n, r) {
        var o, a, s;
        return (
          d.test(t) && (o = i(f.createElement(RegExp.$1))),
          o ||
            ...
            (s = E[n]),
            (s.innerHTML = '' + t),
            (o = i.each(u.call(s.childNodes), function() {
              s.removeChild(this);
            }))),
          R(r) &&
            ((a = i(o)),
      ...
      (C.init = function(t, n) {
        ...
        if ('string' == typeof t)
          if (((t = t.trim()), '<' == t[0] && p.test(t)))
            (r = C.fragment(t, RegExp.$1, n)), (t = null);
          else {
          ...
          if (M(t)) r = q(t);
            ...
            (r = C.fragment(t.trim(), RegExp.$1, n)), (t = null);
          else {
            if (n !== e) return i(n).find(t);
            r = C.qsa(f, t);
          }
      ...
      (i.fn = {
        ...
        is: function(t) {
          return 'string' == typeof t
            ? this.length > 0 && C.matches(this[0], t)
            : t && this.selector == t.selector;
        },
        not: function(t) {
          var n = [];
          if (k(t) && t.call !== e)
        ...
        closest: function(t, e) {
          ...
          return (
            this.each(function(i, o) {
              for (; o && !(r ? r.indexOf(o) >= 0 : C.matches(o, t)); )
        ...
        parents: function(t) {
          for (var e = [], n = this; n.length > 0; )
            n = i.map(n, function(t) {
              return (t = t.parentNode) && !F(t) && e.indexOf(t) < 0
                ? (e.push(t), t)
                : void 0;
            });
          return U(e, t);
        ...
        parent: function(t) {
          return U(P(this.pluck('parentNode')), t);
        },
        children: function(t) {
          return U(
            this.map(function() {
        ...
        attr: function(t, i) {
          ...
          return 'string' != typeof t || 1 in arguments
            ? this.each(function(e) {
                if (1 === this.nodeType)
                  if ($(t)) for (n in t) G(this, n, t[n]);
                  else G(this, t, Y(this, i, e, this.getAttribute(t)));
              })
            : 0 in this &&
              1 == this[0].nodeType &&
        ...
        prop: function(t, e) {
          return (
            (t = A[t] || t),
            'string' != typeof t || 1 in arguments
              ? this.each(function(i) {
                  if ($(t)) for (n in t) this[A[n] || n] = t[n];
                  else this[t] = Y(this, e, i, this[t]);
                })
              : this[0] && this[0][t]
          );
        },
        ...
        offset: function(e) {
          ...
          if (
            ...
            !i.contains(f.documentElement, this[0])
          )
            return { top: 0, left: 0 };
        ...
        offsetParent: function() {
          return this.map(function() {
            for (
              ...
              t && !g.test(t.nodeName) && 'static' == i(t).css('position');
      ...
      b.forEach(function(n, r) {
        ...
        (i.fn[n] = function() {
          ...
          (i.fn[o ? n + 'To' : 'insert' + (r ? 'Before' : 'After')] = function(
            t
          ) {
            return i(t)[n](this), this;
          });
      }),
      (C.Z.prototype = X.prototype = i.fn),
      (C.uniq = P),
  ...
  return (
    ...
    (function(e) {
        ...
        n.split(/\s/).forEach(function(n) {
          ...
          (s.proxy = function(e) {
            ...
            'addEventListener' in t &&
              t.addEventListener(v(s.e), s.proxy, g(s, f));
        });
      }
          ...
          p(t, e, n, i).forEach(function(e) {
            delete s[o][e.i],
              'removeEventListener' in t &&
                t.removeEventListener(v(e.e), e.proxy, g(e, r));
          });
        });
      }
      function S(t, n) {
      ...
      (e.fn.delegate = function(t, e, n) {
                    ...
                    (l = function(t) {
                      ...
                      return a && a !== o
                        ? ((i = e.extend(j(t), {
                          ...
                          (c || u).apply(a, [i].concat(r.call(arguments, 1))))
                        : void 0;
                    }),
                  y(o, t, u, s, n, l || c);
              }));
        ...
        (e.fn.trigger = function(t, n) {
          return (
            (t = a(t) || e.isPlainObject(t) ? e.Event(t) : S(t)),
            (t._args = n),
            this.each(function() {
    ...
    (function(e) {
      ...
      function C(t, n, i, r) {
        return (
          e.isFunction(n) && ((r = i), (i = n), (n = void 0)),
          e.isFunction(i) || ((r = i), (i = void 0)),
          { url: t, data: n, success: i, dataType: r }
        );
      }
      function P(t, n, i, r) {
        var o,
      ...
      (h.href = t.location.href),
        ...
        (e.ajax = function(n) {
          ...
          for (r in e.ajaxSettings)
            void 0 === a[r] && (a[r] = e.ajaxSettings[r]);
          m(a),
            a.crossDomain ||
              ((u = i.createElement('a')),
              (u.href = a.url),
            ...
            (f = a.url.indexOf('#')) > -1 && (a.url = a.url.slice(0, f)),
            j(a);
          var c = a.dataType,
            p = /\?.+=\?/.test(a.url);
          if (
            ...
            return (
              p ||
                (a.url = S(
                  a.url,
                  a.jsonp ? a.jsonp + '=?' : a.jsonp === !1 ? '' : 'callback=?'
                )),
              e.ajaxJSONP(a, s)
            );
          var N,
          ...
          if (
            ...
            (d = a.mimeType || d) &&
              ...
              O.overrideMimeType && O.overrideMimeType(d)),
            (a.contentType ||
              (a.contentType !== !1 &&
                a.data &&
          ...
          if (
            ...
            (O.onreadystatechange = function() {
              if (4 == O.readyState) {
                (O.onreadystatechange = E), clearTimeout(N);
                var t,
                  n = !1;
                if (
                  ...
                  if (
                    ((c =
                      c ||
                      T(a.mimeType || O.getResponseHeader('content-type'))),
                    ...
                    if (n) return b(n, 'parsererror', O, a, s);
                  }
                  y(t, O, a, s);
                } else
                  b(
                    O.statusText || null,
                    O.status ? 'error' : 'abort',
                    O,
                    a,
                    s
                  );
            ...
            return O.abort(), b(null, 'abort', O, a, s), O;
          var A = 'async' in a ? a.async : !0;
          if ((O.open(a.type, a.url, A, a.username, a.password), a.xhrFields))
            for (o in a.xhrFields) O[o] = a.xhrFields[o];
          for (o in g) P.apply(O, g[o]);
          return (
            a.timeout > 0 &&
              (N = setTimeout(function() {
                (O.onreadystatechange = E),
                  O.abort(),
                  b(null, 'timeout', O, a, s);
              }, a.timeout)),
            O.send(a.data ? a.data : null),
            O
          );
        }),
        (e.get = function() {
    ...
    (function(t, e) {
      ...
      o.style.transform === e &&
        t.each(r, function(t, r) {
          return o.style[t + 'TransitionProperty'] !== e
            ? ((n = '-' + t.toLowerCase() + '-'), (i = r), !1)
            : void 0;
        }),
        (s = n + 'transform'),
        (g[(u = n + 'transition-property')] = g[
          (f = n + 'transition-duration')
        ] = g[(l = n + 'transition-delay')] = g[
          (c = n + 'transition-timing-function')
        ] = g[(h = n + 'animation-name')] = g[
          (p = n + 'animation-duration')
        ] = g[(m = n + 'animation-delay')] = g[
          (d = n + 'animation-timing-function')
        ] = ''),
        (t.fx = {
    ...
    (function(e, n) {
      function s(t, i, r, o, a) {
        'function' != typeof i || a || ((a = i), (i = n));
        var s = { opacity: r };
        return (
          o &&
            ((s.scale = o), t.css(e.fx.cssPrefix + 'transform-origin', '0 0')),
          t.animate(s, i, null, a)
        );
      }
      function u(t, n, i, r) {
        return s(t, n, 0, i, function() {
          ...
          h = function(t, n, i) {
            return function(r) {
              (n[t] = this),
                ...
                i === f ? u.notifyWith(n, i) : --s || u.resolveWith(n, i);
            };
          };
        if (o > 1)
          for (f = new Array(o), c = new Array(o), l = new Array(o); o > a; ++a)
            r[a] && t.isFunction(r[a].promise)
              ? r[a]
                  .promise()
                  .done(h(a, l, r))
                  .fail(u.reject)
      ...
      (e.qsa = function(i, r) {
        return f(r, function(o, a, f) {
          try {
            ...
            !o && a
              ? (o = '*')
              : s.test(o) && ((c = t(i).addClass(u)), (o = '.' + u + ' ' + o));
            var l = n(i, o);
          } catch (h) {
            ...
            (f = function(t) {
              (!(O = b(t, 'down')) || y(t)) &&
                ...
                t.touches &&
                  1 === t.touches.length &&
                  n.x2 &&
                  ((n.x2 = void 0), (n.y2 = void 0)),
                (E = Date.now()),
                (T = E - (n.last || E)),
                (n.el = e(
                  'tagName' in C.target ? C.target : C.target.parentNode
                )),
                i && clearTimeout(i),
                (n.x1 = C.pageX),
                (n.y1 = C.pageY),
                T > 0 && 250 >= T && (n.isDoubleTap = !0),
                (n.last = E),
                (a = setTimeout(m, s)),
                u && O && u.addPointer(t.pointerId));
            }),
            (l = function(t) {
              (!(O = b(t, 'move')) || y(t)) &&
                ((C = O ? t : t.touches[0]),
                ...
                (n.x2 = C.pageX),
                (n.y2 = C.pageY),
                (S += Math.abs(n.x1 - n.x2)),
                (j += Math.abs(n.y1 - n.y2)));
            }),
            (c = function(t) {
              (!(O = b(t, 'up')) || y(t)) &&
                (g(),
                (n.x2 && Math.abs(n.x1 - n.x2) > 30) ||
                (n.y2 && Math.abs(n.y1 - n.y2) > 30)
                  ? (o = setTimeout(function() {
                      n.el &&
                        (n.el.trigger('swipe'),
                        n.el.trigger('swipe' + d(n.x1, n.x2, n.y1, n.y2))),
                        (n = {});
                    }, 0))
                  : 'last' in n &&
                    (30 > S && 30 > j
      ...
      if (t.os.ios) {
        ...
        t(document)
          ...
          .bind('gestureend', function(n) {
            e.e2 > 0
              ? (0 != Math.abs(e.e1 - e.e2) &&
                  t(e.target).trigger('pinch') &&
                  t(e.target).trigger(
                    'pinch' + (e.e1 - e.e2 > 0 ? 'In' : 'Out')
                  ),
                (e.e1 = e.e2 = e.last = 0))
              : 'last' in e && (e = {});
          }),
    ...
    (function(t) {
      String.prototype.trim === t &&
        (String.prototype.trim = function() {
          return this.replace(/^\s+|\s+$/g, '');
        }),
        Array.prototype.reduce === t &&
